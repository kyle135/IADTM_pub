...
export FIXEDPOINTARITHMETIC_DIRECTORY			:= $(abspath $(FIXEDPOINTARITHMETIC_INC_MAKEFILE_DIRECTORY)/..)
...
export FIXEDPOINTARITHMETIC_VERILOG_HDL_FILES		:= \
	...
	$(FIXEDPOINTARITHMETIC_DIRECTORY)/units/Subtract/hdl/RippleCarrySubtraction.sv \
